...
const THEME_KEYWORDS: Record<string, string[]> = {
  ...
  'soziale-integration': [
    ...
    'marginalisiert', 'randgruppen', 'integration',
    'sozialhilfeempfänger', 'sozial benachteiligt',
    'gesellschaftliche teilhabe', 'chancengerecht',
  ],
  'digitale-bildung': [
  ...
  klima: [
    ...
    'ressourceneffizienz', 'nachhaltige entwicklung',
  ],
  jugend: [
