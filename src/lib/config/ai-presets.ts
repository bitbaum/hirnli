...
export const AI_PRESETS = [
  ...
  { label: 'Mehr Zahlen', instruction: `Integriere konkrete Zahlen und messbare Fakten aus dem Kontext (z.B. ${DEVICES_YEAR_CURRENT} Geräte, ${CO2_SAVED_PER_LAPTOP} kg CO₂, ${REUSE_RATE}% Reuse-Rate)` },
