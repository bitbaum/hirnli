...
export const EXPENSE_CATEGORIES = [
  { key: 'miete' as const, label: 'Miete & Nebenkosten', codes: '6000, 6400, 6460', color: '#E74C3C' },
  { key: 'personal' as const, label: 'Personal', codes: '5000–5830', color: '#3498DB' },
  { key: 'material' as const, label: 'Material & Beschaffung', codes: '4000, 4400, 4710', color: '#F39C12' },
  { key: 'it' as const, label: 'IT & Kommunikation', codes: '6510, 6511', color: '#9B59B6' },
