...
export const EXPENSE_CATEGORIES = [
  ...
  {
    key: 'abschreibungen' as const,
    label: 'Abschreibungen',
    codes: '6800',
    color: CHART_COLORS.concrete,
  },
  {
    key: 'uebrig' as const,
    label: 'Übriger Betrieb',
    codes: '6100–6900, 8xxx',
...
/** Most recent entry in ANNUAL_PL — may be partial/in-progress year */
export const CURRENT_YEAR_DATA = ANNUAL_PL[ANNUAL_PL.length - 1];
...
export const CUMULATIVE_WARENVERKAUF = ANNUAL_PL.reduce(
  (sum, y) => sum + y.revenueDetail.warenverkauf,
  0,
);
...
export const DATA_QUALITY = {
  ...
  caveat:
    'Seit 2024 wurden keine Aufwände verbucht. Das Geschäftsergebnis 2024–2025 ist nicht berechenbar. Nur Einnahmen sind zuverlässig.',
  anomalousYear: 2019,
  anomalyNote:
    '2019: Grosse Umbuchungen (6700=55.6k, 3805=-34.2k). Aufwandstruktur nicht aussagekräftig.',
} as const;
