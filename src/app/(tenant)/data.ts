...
export const DASHBOARD_QUICKLINKS = [
  {
    ...
    desc: 'Mission, Werte, Community Tech Space',
  },
  { href: '/fundraising', icon: '🎯', title: 'Fundraising', desc: 'Budget, Pipeline, Pakete' },
  {
    ...
    icon: '🏛️',
    title: 'Stiftungen',
    desc: 'Alle Förderstiftungen mit Deadlines',
  },
  { href: '/wirkung', icon: '🌱', title: 'Wirkung', desc: 'CO₂, Geräte, Menschen' },
  { href: '/finanzen', icon: '💰', title: 'Finanzen', desc: 'Einnahmen, Ausgaben, 8-Jahres-Trend' },
  { href: '/preismodell', icon: '🏷️', title: 'Preismodell', desc: 'Solidarisches 4-Stufen-Modell' },
