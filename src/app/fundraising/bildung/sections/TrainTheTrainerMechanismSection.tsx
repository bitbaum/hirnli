      ...
      <Card>
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-pillar-vision/15 flex items-center justify-center text-pillar-vision font-bold">1</div>
            <div className="flex-1">
              <h3 className="heading-item mb-2">Bildungsprogrammleiter:innen trainieren Trainer:innen</h3>
          ...
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-pillar-vision/20 flex items-center justify-center text-pillar-vision font-bold">2</div>
            <div className="flex-1">
          ...
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0 w-12 h-12 rounded-full bg-pillar-vision/30 flex items-center justify-center text-pillar-vision font-bold">3</div>
            <div className="flex-1">
