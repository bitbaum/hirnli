    ...
    <section className="mb-8">
      ...
      <Card>
        <p className="text-sm text-text-secondary mb-6">
          Wir suchen <strong>Stiftungsfinanzierung über 3 Jahre</strong> (CHF{' '}
          {formatNumber(BPL_TOTAL_COST_PER_YEAR)}/Jahr, degressiv), um die
          Bildungsprogrammleiter:innen-Stellen zu finanzieren, während wir parallel Einnahmequellen
          aufbauen.
        </p>
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <ul className="text-sm text-text-secondary space-y-1 list-disc list-inside">
                ...
                <li>
                  Finanzierung: 100% Stiftungsgelder (1× BPL: CHF {formatNumber(hardware_bpl_cost)}{' '}
                  inkl. Sozialabgaben)
                </li>
                <li>
                  Einnahmen: Workshop-Fees beginnen (CHF 5-10k, nicht ausreichend für Selbsttragung)
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <ul className="text-sm text-text-secondary space-y-1 list-disc list-inside">
                ...
                <li>
                  Finanzierung: degressiv (Stiftungsgelder sinken, Eigenmittel durch Kurseinnahmen
                  steigen)
                </li>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <ul className="text-sm text-text-secondary space-y-1 list-disc list-inside">
                <li>
                  Train-the-Trainer voll etabliert, {PEOPLE_REACHED_PER_YEAR} Menschen/Jahr erreicht
                </li>
                <li>Trainer:innen trainieren ohne unsere direkte Beteiligung</li>
                <li>
                  Finanzierung: 50% Stiftungsgelder, 50% Eigenmittel (Workshop-Fees, Corporate
                  Training)
                </li>
