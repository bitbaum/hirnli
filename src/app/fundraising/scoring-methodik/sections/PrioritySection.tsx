          ...
          <div className="space-y-2">
              ...
              return (
                <div key={d.level} className="flex items-center justify-between rounded-lg border border-border/50 p-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="w-10 text-right text-sm font-bold tabular-nums text-grey-dark">{priorityCounts[d.level]}</span>
                  </div>
                </div>
              );
            })}
            <div className="flex items-center justify-between rounded-lg border border-border/50 p-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="w-10 text-right text-sm font-bold tabular-nums text-grey-dark">{priorityCounts[4]}</span>
              </div>
            </div>
          </div>
          <p className="mt-2 text-sm text-text-muted">
