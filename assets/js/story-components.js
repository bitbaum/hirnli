/**
 * Story Components - SSOT for Revamp-IT Narrative Content
 *
 ...
 * - Config Over Code: Non-engineers can edit this without touching JS logic
 * - Modularity: Each section independent, composable for different audiences
 *
 * STRUCTURE:
 * 1. CORE_FACTS - Unchanging truths about Revamp-IT (links to number-sources.js)
...
// ============================================================================
// CORE FACTS - Unchanging truths (references number-sources.js IDs)
// ============================================================================
const CORE_FACTS = {
  organization: {
    name: 'Revamp-IT',
  ...
  // These IDs link to number-sources.js for actual values
  metrics: {
    financial: {
...
const WHY = {
  ...
  klima: {
    ...
    hook: `Während wir über Klimaziele diskutieren, landen funktionierende Laptops im Müll.
           Jedes weggeworfene Gerät bedeutet 300 kg CO₂, die umsonst produziert wurden.
           Das muss nicht sein.`,
    problem: `Die IT-Industrie setzt auf geplante Obsoleszenz. Geräte werden nach 3-4 Jahren
              ersetzt, obwohl sie technisch noch Jahre funktionieren könnten. Die Umweltkosten
              dieser Wegwerfkultur sind enorm.`,
    solution: `Revamp-IT verlängert die Lebensdauer von IT-Geräten um durchschnittlich 5 Jahre.
               Durch professionelles Refurbishing und Linux-Installation werden "alte" Laptops
               zu leistungsfähigen, sicheren Arbeitsgeräten.`,
  ...
  kreislaufwirtschaft: {
    ...
    hook: `In einer Welt der Wegwerfprodukte setzen wir auf das Gegenteil:
           Jedes Gerät, das wir reparieren, ist ein Gerät weniger im Müll.`,
    problem: `Die lineare Wirtschaft (produzieren → nutzen → wegwerfen) stösst an ihre Grenzen.
              Ressourcen werden knapp, Müllberge wachsen. Besonders bei Elektronik ist die
              Lebensdauer oft künstlich verkürzt.`,
    solution: `Revamp-IT praktiziert Kreislaufwirtschaft konkret: Refurbishing, Reparatur,
               Ersatzteilgewinnung. Was nicht mehr reparierbar ist, wird fachgerecht recycelt.
  ...
  sozial: {
    ...
    hook: `Menschen, die es auf dem Arbeitsmarkt schwer haben, brauchen mehr als
           Bewerbungstraining. Sie brauchen echte Arbeit, echte Verantwortung,
           echte Erfolgserlebnisse.`,
    problem: `Langzeitarbeitslose, Menschen mit Migrationshintergrund, Wiedereinsteigerinnen -
              sie alle kämpfen gegen Vorurteile und fehlende Berufserfahrung. Ohne Praxis
              keine Stelle, ohne Stelle keine Praxis.`,
    solution: `Revamp-IT bietet Praktikumsplätze in einem echten Betrieb. Unsere
               Praktikant:innen reparieren echte Geräte für echte Kunden. Sie lernen
               IT-Skills, die auf dem Arbeitsmarkt gefragt sind.`,
  ...
  bildung: {
    ...
    hook: `In einer Welt, in der fast jeder Job digitale Skills verlangt,
           darf niemand zurückbleiben. Wer nicht mitkommt, wird abgehängt.`,
    problem: `Viele Menschen haben keinen Zugang zu bezahlbarer IT-Bildung.
              Kommerzielle Kurse sind teuer, Volkshochschul-Angebote oft oberflächlich.
              Und wer keinen eigenen Computer hat, kann nicht üben.`,
    solution: `Revamp-IT verbindet beides: günstige refurbished Geräte UND
               praxisnahe Workshops. Wir zeigen, wie man Linux nutzt, wie man
               Probleme selbst löst, wie man digital souverän wird.`,
  ...
  digital: {
    ...
    hook: `Wer Microsoft oder Apple nutzt, gibt Kontrolle ab - über Updates,
           über Daten, über die Lebensdauer des Geräts. Es gibt Alternativen.`,
    problem: `Proprietäre Software schafft Abhängigkeiten. Zwangsupdates machen
              funktionierende Hardware "obsolet". Daten fliessen in ausländische Clouds.
              Kleine Organisationen haben keine Wahl - oder kennen sie nicht.`,
    solution: `Revamp-IT installiert Linux auf allen refurbished Geräten. Wir zeigen,
               dass Open Source funktioniert - zuverlässig, sicher, kostenlos.
...
const HOW = {
  ...
  track_record: {
    ...
    text: `Seit 2003 repariert, refurbished und verkauft Revamp-IT Computer in Zürich.
           Was als kleine Werkstatt begann, ist heute ein etablierter Betrieb mit
           8 Mitarbeitenden und einem klaren Auftrag: IT-Geräte länger nutzen,
           Menschen eine Chance geben.`,
    proof_points: [
      { label: 'Gegründet', value: '2003' },
      { label: 'Eigenfinanzierungsgrad', value: '96%', metric_id: 'financial_self_financing_2025' },
      { label: 'Praktikant:innen betreut', value: '100+', metric_id: 'praktikanten_100' },
...
const PROJECTS = {
  ...
  device_repair: {
    ...
    summary: `Revamp-IT repariert und refurbished IT-Geräte, die sonst im Müll landen würden.
              Durch professionelle Aufbereitung und Linux-Installation werden "alte" Geräte
              zu vollwertigen Arbeitsgeräten mit 5+ Jahren zusätzlicher Lebensdauer.`,
    goals: [
  ...
  spare_parts: {
    ...
    summary: `Viele Reparaturen scheitern an fehlenden Ersatzteilen - Hersteller liefern nicht mehr.
              Revamp-IT gewinnt Ersatzteile aus nicht mehr reparierbaren Geräten und ermöglicht
              so Reparaturen, die sonst unmöglich wären.`,
    goals: [
  ...
  work_integration: {
    ...
    summary: `Menschen, die es auf dem Arbeitsmarkt schwer haben, erhalten bei Revamp-IT
              Praktikumsplätze. Sie arbeiten an echten Projekten, lernen IT-Skills und
  ...
  digital_training: {
    ...
    summary: `Revamp-IT bietet praxisnahe Workshops zu Linux, Open-Source-Software und
              grundlegenden IT-Skills. Zielgruppe sind Menschen, die sich kommerzielle
  ...
  program_management: {
    ...
    summary: `Um die Wirkung zu skalieren, braucht Revamp-IT professionelle Projektkoordination.
              Eine zusätzliche Stelle ermöglicht systematisches Tracking, bessere Betreuung
...
const BUDGET_TEMPLATES = {
  ...
  line_items: {
    personnel: [
      { label: 'Projektkoordination', description: 'Koordination, Monitoring, Berichterstattung' },
      { label: 'Fachliche Betreuung', description: 'Technische Anleitung und Qualitätssicherung' },
      { label: 'Sozialpädagogische Begleitung', description: 'Betreuung von Praktikant:innen' }
    ],
    operations: [
      { label: 'Material und Werkzeug', description: 'Ersatzteile, Verbrauchsmaterial' },
      { label: 'Infrastruktur', description: 'Anteilige Raumkosten, IT-Infrastruktur' },
      { label: 'Lizenzen und Software', description: 'Falls benötigt (meist Open Source)' }
    ],
    program: [
      { label: 'Workshop-Durchführung', description: 'Vorbereitung, Material, Räume' },
      { label: 'Teilnehmer-Support', description: 'Geräte für Übungen, Unterlagen' }
    ]
  },
...
const THEME_SYNONYMS = {
  ...
  kreislaufwirtschaft: ['Kreislaufwirtschaft', 'Circular Economy', 'Ressourcenschonung', 'Upcycling', 'Refurbishing', 'Reparatur'],
  sozial: ['Soziale Integration', 'Soziale Inklusion', 'Arbeitsintegration', 'Wiedereingliederung', 'Second Chance'],
  bildung: ['Bildung', 'Digitale Teilhabe', 'Digitale Bildung', 'Medienkompetenz', 'IT-Bildung'],
  digital: ['Digitale Souveränität', 'Open Source', 'Freie Software', 'Linux', 'Digitale Unabhängigkeit']
};
 ...
 */
function getProjectsByTheme(theme) {
 ...
 * Get evidence by key
 */
function getEvidence(category, key) {
 ...
 */
function composeStory(primaryTheme, secondaryThemes = []) {
  ...
  return {
    ...
    how: {
      ...
      competencies: allThemes.map(t => {
        if (t === 'klima' || t === 'kreislaufwirtschaft') return HOW.environmental;
    ...
    evidence: WHY[primaryTheme]?.evidence?.map(key => {
...
if (typeof window !== 'undefined') {
  window.CORE_FACTS = CORE_FACTS;
  window.EVIDENCE = EVIDENCE;
  window.WHY = WHY;
  window.HOW = HOW;
  window.PROJECTS = PROJECTS;
  window.BUDGET_TEMPLATES = BUDGET_TEMPLATES;
  window.THEME_SYNONYMS = THEME_SYNONYMS;
  window.composeStory = composeStory;
  window.getWhy = getWhy;
  window.getProjectsByTheme = getProjectsByTheme;
