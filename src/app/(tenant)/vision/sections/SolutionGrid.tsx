          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-text-secondary mb-3">
                <strong>Was wir heute haben:</strong> Laden + Lager (genaue Quadratmeter werden im
                Rahmen unserer Data-Strategie dokumentiert). Verteilt auf 2 Standorte, suboptimal
                organisiert.
              </p>
              <p className="text-sm text-text-secondary mb-3">
              ...
              <div className="bg-accent-muted rounded-lg p-3 mb-3">
                <p className="text-sm text-primary">
                  <strong>Warum das hilft:</strong> Mehr Raum bedeutet mehr parallele
                  Arbeitsstationen, bessere Trennung (Verkauf/Werkstatt/Schulung), weniger Chaos.{' '}
                  <strong>Aber:</strong> Raum allein reicht nicht — siehe Punkt 2.
                </p>
              </div>
              <Link
        ...
        <Card className="border-l-4 border-l-pillar-vision">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-text-secondary mb-3">
                <strong>Das ist der eigentliche Game-Changer:</strong> Zwei{' '}
                <strong>bezahlte Fachleute</strong>, die professionell organisieren, trainieren und
                Programme leiten.
              </p>
              <div className="space-y-3 mb-4">
                <div className="bg-pillar-vision/10 rounded-lg p-3">
                  <p className="heading-detail text-pillar-vision mb-1">
