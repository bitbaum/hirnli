...
export const NUMBERS_REGISTRY: Record<string, NumberSource> = {
  ...
  CURRENT_WORKSHOP_SPACE: {
    value: 120,
    label: 'm² aktuelle Werkstatt',
    source: {
      methodology: 'Mietvertrag Hardturmstrasse',
      confidence: 'high',
      lastVerified: '2026-02-01',
    },
    category: 'operations',
  ...
  HUB_SPACE_TOTAL: {
    value: 1_000,
    label: 'm² Community Tech Hub',
    source: {
      methodology: 'Konzept basierend auf vergleichbaren Makerspaces in Zürich',
      calculation: 'Werkstatt 650m² + AI Lab 150m² + Event Space 100m² + Offices 100m²',
  ...
  EFFICIENCY_GAIN: {
    ...
    source: {
      ...
      calculation: 'Miete/Gerät -40% (7.8× Volume) + Prozesszeit -30% + Fehlerkosten -60% → Ø -31% Kosten',
      confidence: 'estimated',
      lastVerified: '2026-02-11',
  ...
  SCALE_MULTIPLIER: {
    ...
    source: {
      ...
      calculation: '120m² → 1000m² = 8.3× Raum, aber Prozess-Limits → 7.8× realistisches Volumen',
      confidence: 'estimated',
      lastVerified: '2026-02-11',
  ...
  TEAM_MANAGER_RATIO: {
    ...
    source: {
      ...
      calculation: '1 Education Manager → 5 Trainer ausbilden → 100 Teilnehmer erreichen',
      confidence: 'estimated',
      lastVerified: '2026-02-11',
