    ...
    items: [
      {
        ...
        children: [
          ...
          { msg: 'wieWirArbeiten', href: '/wie-wir-arbeiten', hasDesc: true },
          {
            ...
            href: '/finanzen',
            hasDesc: true,
            values: { range: FINANCIAL_YEAR_RANGE, label: FINANCIAL_YEAR_LABEL },
          },
            ...
            items: [
              {
                ...
                hasDesc: true,
                highlight: true,
                values: { space: HUB_SPACE_DISPLAY },
              },
            ...
            items: [
              {
                ...
                hasDesc: true,
                values: { count: stiftungenCount },
              },
              {
                msg: 'vorlagen',
                href: '/fundraising/gesuch-vorlagen',
                hasDesc: true,
                values: { count: TEMPLATE_TYPES.length },
              },
              ...
              {
                msg: 'pipelineMethodik',
                href: '/fundraising/pipeline-methodik',
                hasDesc: true,
                values: { universe: SWISS_FOUNDATIONS_DISPLAY },
              },
            ],
          },
        ],
