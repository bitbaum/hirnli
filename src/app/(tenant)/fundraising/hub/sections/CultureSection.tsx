  ...
  return (
    <section className="mb-8">
      ...
      <p className="text-sm text-text-secondary mb-6">
        <strong>Warum Kultur?</strong> Weil Menschen nicht zu einer &bdquo;Werkstatt&ldquo; kommen —
        aber zu einem Konzert, einer Ausstellung, einem Filmabend. Kultur ist der Einstiegspunkt.
        Und dann sehen sie: Alte Synths machen Musik. Computer sind Geschichte. Reparatur ist
        Kultur, nicht Pflicht.
      </p>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border-l-4 border-l-danger">
          <HubCardHeader
            ...
            subtitle="60 m² — Technik-Geschichte zum Anfassen"
            subtitleClassName="text-danger"
            badgeColor="pink"
            badgeText={formatCHF(CULTURE_ASPIRATIONAL_COSTS.computer_museum)}
          />
          <p className="text-sm text-text-secondary mb-4">
            Von Commodore 64 bis zur ersten Cray: Computergeschichte als lebendiges Archiv. Zeigt,
            dass alte Hardware wertvoll ist — nicht Müll.
          </p>
          <div className="text-sm mb-3">
            <h4 className="heading-detail mb-2">Ausstellungsflächen & Inhalte</h4>
            <ul className="space-y-1 text-text-secondary text-sm">
              <li>
                • <strong>40 m² Permanent-Ausstellung</strong> (Commodore, Amiga, NeXT, Cray)
              </li>
              <li>
                • <strong>20 m² Wechselausstellungen</strong> (E-Waste-Kunst, Tech-Fotografie)
              </li>
        ...
        <Card className="border-l-4 border-l-chart-5">
          <HubCardHeader
            ...
            subtitle="50 m² — Alte Elektronik wird Musik"
            subtitleClassName="text-chart-5"
            badgeColor="purple"
            badgeText={formatCHF(CULTURE_ASPIRATIONAL_COSTS.synth_lab)}
          />
          <p className="text-sm text-text-secondary mb-4">
            Vintage-Synths restaurieren, Circuit-Bending lernen, Live-Konzerte veranstalten. Musik
            als Zugang zu Technologie.
          </p>
          <div className="text-sm mb-3">
            <h4 className="heading-detail mb-2">Arbeitsplätze & Ausstattung</h4>
            <ul className="space-y-1 text-text-secondary text-sm">
              <li>
                • <strong>6× Synth-Restaurierungs-Arbeitsplätze</strong> (Lötkolben, Oszilloskop)
              </li>
              <li>
                • <strong>10-15× Vintage-Synths</strong> (Roland, Korg, Moog aus 70er/80er)
              </li>
              <li>
                • <strong>Modular-Synthese-Setup</strong> für Workshops
              </li>
              <li>
                • <strong>20m² Performance-Bereich</strong> für Konzerte (20-30 Besucher)
              </li>
        ...
        <Card className="border-l-4 border-l-warning">
          <HubCardHeader
            ...
            subtitle="40 m² — Elektroschrott wird Kunst"
            subtitleClassName="text-warning"
            badgeColor="orange"
            badgeText={formatCHF(CULTURE_ASPIRATIONAL_COSTS.ewaste_art_studio)}
          />
          <p className="text-sm text-text-secondary mb-4">
          ...
          <div className="text-sm mb-3">
            ...
            <ul className="space-y-1 text-text-secondary text-sm">
              <li>
                • <strong>3× Resident Artists-Atelierplätze</strong> (je 10-12m², 3-6 Monate)
              </li>
        ...
        <Card className="border-l-4 border-l-pillar-social">
          <HubCardHeader
            ...
            subtitle="100 m² — Tags Workshops, abends Events"
            subtitleClassName="text-theme-arbeit"
            badgeColor="teal"
            badgeText={formatCHF(CULTURE_ASPIRATIONAL_COSTS.event_multifunction)}
          />
          <p className="text-sm text-text-secondary mb-4">
            Flexibler Raum für 50-80 Personen. Tags: Workshops, Co-Working. Abends: Konzerte, Film,
            Talks.
          </p>
          <div className="text-sm mb-3">
            ...
            <ul className="space-y-1 text-text-secondary text-sm">
              <li>
                • <strong>Bestuhlung für 50-80 Personen</strong> (flexibel)
              </li>
        ...
        <Card className="border-l-4 border-l-success">
          <HubCardHeader
            ...
            subtitle="50 m² — Gemeinsam essen, gemeinsam lernen"
            subtitleClassName="text-success"
            badgeColor="green"
            badgeText={formatCHF(CULTURE_ASPIRATIONAL_COSTS.community_kitchen)}
          />
          <p className="text-sm text-text-secondary mb-4">
            Fair-Trade-Café tags, Community-Kitchen abends. Niederschwelliger Treffpunkt — keine
            Konsumpflicht.
          </p>
          <div className="text-sm mb-3">
            ...
            <ul className="space-y-1 text-text-secondary text-sm">
              <li>
                • <strong>15-20 Sitzplätze</strong> (Café-Bereich)
              </li>
              <li>
                • <strong>30 Plätze beim Community-Dinner</strong> (1×/Woche)
              </li>
        ...
        <Card className="border-l-4 border-l-warning">
          <HubCardHeader
            icon="🔧"
            title="Repair Café"
            subtitle="30 m² — Community-Reparatur, 2×/Monat"
            subtitleClassName="text-warning"
            badgeColor="yellow"
            badgeText={formatCHF(CULTURE_ASPIRATIONAL_COSTS.repair_cafe)}
          />
          <p className="text-sm text-text-secondary mb-4">
            Öffentliche Reparatur-Events: Bring dein kaputtes Gerät, wir helfen dir es zu
            reparieren. Lernen durch Tun.
          </p>
          <div className="text-sm mb-3">
            <h4 className="heading-detail mb-2">Arbeitsplätze & Format</h4>
            <ul className="space-y-1 text-text-secondary text-sm">
              <li>
                • <strong>6× Reparatur-Arbeitsplätze</strong> (Werkzeuge & Material vor Ort)
              </li>
