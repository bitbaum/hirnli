...
export const HUB_IMAGE_PROMPTS: ImagePrompt[] = [
  ...
  },
  {
    ...
    negative_prompt:
      'messy cables, cluttered, outdated equipment, dark, sci-fi unrealistic, consumer hardware',
    style_keywords: [
      'data center design',
  ...
  },
  {
    ...
    negative_prompt:
      'traditional classroom, boring, cramped, outdated computers, corporate training room, dark',
    style_keywords: [
      'modern classroom',
  ...
  },
  {
    ...
    negative_prompt:
      'messy cables, cluttered, traditional recording studio, corporate, boring, dark basement',
    style_keywords: [
      'music studio design',
  ...
  },
  {
    ...
    negative_prompt:
      'cluttered pawn shop, messy, dark, warehouse, traditional computer store, corporate',
    style_keywords: [
      'retail design',
      'electronics store',
      'sustainable retail',
  ...
  },
  {
    ...
    negative_prompt:
      'run-down, abandoned, warehouse, ugly, corporate tower, traditional office building',
    style_keywords: [
      'industrial architecture',
      'Swiss design',
      'sustainable building',
      'modern renovation',
      'community space exterior',
    ],
    aspect_ratio: '16:9',
    suggested_tools: ['Midjourney', 'DALL-E 3', 'Stable Diffusion XL'],
  },
...
function getFullPrompt(spaceName: string): string {
  ...
  fullPrompt +=
    ' High quality, professional photography, realistic, detailed, well-lit, architectural digest style.';
