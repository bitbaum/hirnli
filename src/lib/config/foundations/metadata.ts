...
export const NOT_RECOMMENDED = [
  ...
  { name: 'Stiftung für Bevoelkerung, Migration und Umwelt', reason: 'Aufgeloest Mai 2020' },
  ...
  { name: 'Stiftung Fritz Boesch', reason: 'Individuelle Stipendien nur für Bewohner:innen Lyss (BE) unter 20 Jahren' },
  ...
  { name: 'Limmat Stiftung', reason: 'Religioese Ausrichtung (Opus Dei) - nicht passend für unabhaengiges Sozialunternehmen' },
  ...
  { name: 'Paradies-Stiftung für soziale Innovation', reason: 'Nimmt keine Gesuche an - Stiftungsrat waehlt proaktiv aus' },
  { name: 'Stiftung für angepasste Technologie und Sozialoekologie', reason: 'Operativ (Oekozentrum) - kein Förderprogramm für externe Projekte' },
