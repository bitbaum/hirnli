/**
 * Gesuch Templates — Virtual foundations per Robert Schmuki type
 *
...
/** Virtual foundations per type — placeholder data for template generation */
export const TEMPLATE_FOUNDATIONS: Record<FoundationType, Foundation> = {
  A: {
    slug: 'vorlage-typ-a',
