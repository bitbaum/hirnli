  ...
  return (
    <section className="mb-8">
      ...
      <p className="text-sm text-text-secondary mb-6">
        ...
        <strong> Phase 2 (2029-2030):</strong> Skalierung - volle Kapazität, zusätzliche Programme,
        nachhaltige Selbsttragung.
      </p>
      <Card>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <ul className="text-sm text-text-secondary space-y-1 list-disc list-inside">
                ...
                <li>
                  <strong>Data-Strategie:</strong> Systematische KPI-Erfassung etablieren
                  (Geräte/Monat, Menschen/Jahr, Wartezeiten)
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <ul className="text-sm text-text-secondary space-y-1 list-disc list-inside">
                ...
                <li>
                  Kapazität: ~{DEVICES_PER_MONTH_TARGET} Geräte/Monat, {PEOPLE_REACHED_DISPLAY}{' '}
                  trainiert
                </li>
