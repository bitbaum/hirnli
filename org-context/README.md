...
rewrite the 14 ORG-SPECIFIC files for a new organization.
...
4. Claude reads everything, rewrites the 14 files, runs the pipeline
...
Claude reads all documents and rewrites these 14 ORG-SPECIFIC files:
...
├── revamp-it/             ← Reference: current org (docs live in the 14 files)
